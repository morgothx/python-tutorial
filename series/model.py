...
def procesarString (s, s2):
    ...
    train_data = keras.preprocessing.sequence.pad_sequences(text, value=0, padding='post', maxlen=512*2)
    return train_data
...
def predict(text):
    ...
    model2.load_weights(fpath(__name__, "cp.ckpt.data-00000-of-00001"))
    tags = [
                'Kit Cocina',
                'Gastos notariales y de documentación',
                'Prorroga Alojamiento temporal - Arriendo',
                'Kit Dormitorio',
                'Gastos de atención en salud',
                'Egreso de hotel',
                'Visitas para arrendamiento',
                'Unidades de redención Alimentación - Aseo',
                'Vestuario',
                'Servicios funerarios',
                'Kit de vivienda saludable ',
                'Transporte emergencia',
                'Remisión albergue',
                'Remision de hotel',
                'Orientación oferta distrital',
                'Arriendo',
                'Prórroga de hotel',
                'Alojamiento temporal - Arriendo',
                'Remisión Alojamiento temporal - Albergue',
                'Prórroga de arriendo',
                'Egreso Alojamiento temporal - Albergue',
